...
- Read online via companion novel sites
...
1. Optional cover under `site/ebooks/covers/`.
2. Append an entry to `site/catalog.json` with a `readUrl` pointing at the online reader.
